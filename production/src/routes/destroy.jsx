...
/*From the reactrouter tutorial: 
    "When the user clicks the submit button:

    1. <Form> prevents the default browser behavior of sending 
    a new POST request to the server, but instead emulates the 
    browser by creating a POST request with client side routing
...
export async function action({ params }) {
    // throw new Error("uh oh"); // this is how to throw an error
